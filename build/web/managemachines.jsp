<%-- 
    Document   : managemachines
    Created on : Jan 31, 2022, 6:22:52 AM
    Author     : hilma
--%>
...
<html>
    ...
    <title>Admin Machines - Farmhouse</title>
...
<body>
    ...
    <div class="mt-24">
        <h1 class="text-center text-3xl mb-10">Manage Machines</h1>
        <table class="mx-auto">
            ...
            <tbody class="bg-white">
                <c:forEach items="${sessionScope.admmachinelist}" var="currentsession" varStatus="loop">
                <tr>
                    <td class="px-6 py-4 text-sm text-gray-500 max-w-[24px] truncate">
                        <c:out value="${currentsession.id}" />
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-500 max-w-[24px] truncate">
                        <c:out value="${currentsession.machine_name}" />
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-500 max-w-[24px] truncate">
                        <c:out value="${currentsession.price}" />
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-500 max-w-[32px] truncate">
                        <c:out value="${currentsession.model}" />
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-500 max-w-[24px] truncate">
                        <c:out value="${currentsession.machine_desc}" />
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-500 max-w-[24px] truncate">
                        <c:out value="${currentsession.year}" />
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-500 max-w-[24px] truncate">
                        <c:out value="${currentsession.img}" />
                    </td>
                    <td class="px-6 py-4">
                        <a href="editmachine?id=${currentsession.id}" class="px-4 py-1 text-sm text-white bg-blue-400 rounded">Edit</a>
                    </td>
                    <td class="px-6 py-4">
                        <a href="deletemachine?id=${currentsession.id}" class="px-4 py-1 text-sm text-white bg-red-400 rounded">Delete</a>
                    </td>
                </tr>
                </c:forEach>
            </tbody>
        ...
        <div>
        <form action="addmachines" method="post">
                <div class="mx-auto">
                    ...
                    <div class="my-4 text-center">
                        ...
                        <input class="border" type="text" name="model" required>
                    </div>
                    <div class="my-4 text-center">
                    ...
                    <div class="my-4 text-center">
                        ...
                        <input class="border" type="text" name="year" required>
                    </div>
                    <div class="my-4 text-center">
